...
<!-- right column -->
	<div class="column padded">
		...
		<form:form action="/addHouse" method="post" modelAttribute="newHouse">
			<form:input type="hidden" path="houseCreator" value="${user.id}"/>
   			...
   			<div>
   				...
   				<form:input path="streetAddress" class="form-control"></form:input>
   			</div>
   			<div>
   				...
   				<form:input path="streetAddress2" class="form-control"></form:input>
   			</div>
   			<div>
   			...
   			<div>
   				...
   				<form:input path="notes" class="form-control"></form:input>
   			</div>
